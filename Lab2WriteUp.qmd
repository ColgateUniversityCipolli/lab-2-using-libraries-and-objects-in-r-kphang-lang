...
# Solution
## Histogram
According to the histogram, there are the most of the Adelle species in general. In terms of body mass in grams, both Adelle and Chinstrap have a similar range of body mass from around 2000-5000 with peaks around 3500+. In contrast, the Gentoo species has greater body mass, ranging from around 4000-6000.
...
#| size: "scriptsize"
#| code-fold: FALSE
(treatment.repeating.seq <- rep(c("Control", "Treatment A", "Treatment B"), times=3))
```
